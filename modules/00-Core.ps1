...
$colores = @("Magenta", "Cyan", "Yellow", "Green", "Red", "Blue")
$colorAleatorio = $colores | Get-Random
Write-Host $asciiArt -ForegroundColor $colorAleatorio
    Write-Host ""
    Write-Host "  ❤ Darling System-CherryRed Flavor❤" -ForegroundColor magenta
    Write-Host "  ❤ Creado con amor y vocaloid por MIMASYS & Qwen❤" -ForegroundColor magenta
    write-Host "  ❤ Sabor inspirado en el album Darling Syndrome del productor japones Kairiki Bear❤" -ForegroundColor magenta
    write-Host "  ❤ Chu.❤" -ForegroundColor magenta
    Write-Host ""
    Pause-Kit
}
